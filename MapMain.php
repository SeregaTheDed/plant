...
<div class="Wrapper1">
    <div class="glavn">
            ...
            <a class="flower2_map" href="#">
                <a class="inf7" href="#">Не забудете<br> полить<br> растение</a>
                <a class="inf8" href="Map.php">Найдёте <br>людей <br>по интересам</a>

            </a>
        <h1 class="inf6">Помощь новичкам или любителям в уходе за растениями!</h1>
...
</div>  <img class="girl" src="imagesss/girl.png" width="450" height="400">
